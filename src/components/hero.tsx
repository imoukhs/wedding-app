  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-8 py-24 text-center">
      ...
      <motion.div
        ...
        className="relative z-10 font-[family-name:var(--font-display)] text-[clamp(0.95rem,5vw,2.2rem)] font-semibold tracking-wider text-white mt-2 whitespace-nowrap"
      >
        {coupleName}
      </motion.div>
